      ...
      itemBuilder: (context) => const [
        PopupMenuItem<void>(
          ...
          child: SizedBox(
            width: 220,
            child: Text(
              'DSS otomatis memakai EC sebagai acuan utama kebutuhan larutan N/P/K, sedangkan kelembapan dan suhu mengatur Pompa Air. Nilai N/P/K sensor dipakai sebagai estimasi/tren pendukung, bukan pemicu pompa unsur secara terpisah.',
              style: TextStyle(
                fontSize: 12,
                height: 1.35,
